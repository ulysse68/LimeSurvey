<div class='menubar surveybar'>
    ...
    <div class='menubar-main'>
        ...
        <ul class='sf-menu'>
            ...
            <li><a href='#'>
                    <img src='<?php echo $sImageURL;?>display_export.png' alt='<?php eT("Display / Export");?>' width="<?php echo $iIconSize;?>" height="<?php echo $iIconSize;?>"/></a><ul>
                    <?php if($surveyexport) { ?>
                        <li><a href='#'>
            ...
            <li><a href='#'><img src='<?php echo $sImageURL;?>responses.png' alt='<?php eT("Responses");?>' width="<?php echo $iIconSize;?>" height="<?php echo $iIconSize;?>"/></a><ul>
