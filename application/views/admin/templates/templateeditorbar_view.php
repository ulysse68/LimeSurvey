    ...
    <div class='menubar-main'>
        <div class='menubar-left'>
            ...
            <?php if(is_writable($tempdir) && is_writable($usertemplaterootdir))
                {?>
                <a href='<?php echo $this->createUrl('admin/templates/sa/upload'); ?>' target="_top">
                ...
                <a href='#' onclick='if (confirm("<?php eT("Are you sure you want to delete this template?", "js"); ?>")) window.open("<?php echo $this->createUrl('admin/templates/delete/templatename/'.$templatename); ?>", "_top")' >
            ...
            <?php
                ...
                { ?>
                <img src='<?php echo $sImageURL; ?>export_disabled.png' alt='<?php echo gT("Export template").' - '.sprintf(gT("Please change the directory permissions of the folder %s in order to enable this option"),$tempdir); ?>' />
                <img src='<?php echo $sImageURL; ?>import_disabled.png' alt='<?php echo gT("Import template").' - '.sprintf(gT("Please change the directory permissions of the folder %s in order to enable this option"),$tempdir); ?>' title='' />
                <img src='<?php echo $sImageURL; ?>separator.gif' class='separator' alt='' />
                <a href='#' onclick="javascript: copyprompt('<?php eT("Please enter the name for the copied template:"); ?>', '<?php echo gT("copy_of_")."$templatename"; ?>', '<?php echo $templatename; ?>', 'copy')">
                    <img src='<?php echo $sImageURL; ?>copy.png' alt='<?php eT("Copy template"); ?>' /></a>
                <?php
