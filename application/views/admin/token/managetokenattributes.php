<?php if( count($tokenfieldlist)) { ?>
    ...
    <br /><br />
<?php } ?>
<div class='header ui-widget-header'><?php eT("Add or delete token attributes"); ?></div><p>

<?php echo sprintf(gT('There are %s user attribute fields in this token table'), $nrofattributes); ?></p>
