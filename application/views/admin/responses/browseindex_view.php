...
<table class='statisticssummary'>
  <caption class="header ui-widget-header"><?php eT("Token summary"); ?></caption>
    <tfoot><tr><th><?php eT("Total records in this token table"); ?></th><td><?php echo $tokeninfo['tkcount']; ?></td></tr></tfoot>
    <tbody>
        <tr><th><?php eT("Total invitations sent"); ?></th><td><?php echo $tokeninfo['tksent']; ?></td></tr>
        <tr><th><?php eT("Total surveys completed"); ?></th><td><?php echo $tokeninfo['tkcompleted']; ?></td></tr>
        <tr><th><?php eT("Total with no unique Token"); ?></th><td><?php echo $tokeninfo['tkinvalid'] ?></td></tr>
    </tbody>
</table>
<?php } ?>
