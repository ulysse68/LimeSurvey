<div class="tabpage_<?php echo $lang; ?>">
    <ul>
        ...
        <li><label for='quotals_url_<?php echo $lang;?>'><?php eT("Quota message");?>:</label><input id="quotals_url_<?php echo $lang;?>" name="quotals_url_<?php echo $lang;?>" type="text" size="30" maxlength="255" value="<?php echo htmlspecialchars($langquotainfo['quotals_url']);?>" /></li>
