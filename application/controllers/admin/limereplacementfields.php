    ...
    private function _getReplacementFields($fieldtype, $surveyid)
    {
        ...
        switch ($fieldtype)
        {
            ...
            case 'editend': // for translation
                $replFields[] = array('TOKEN:FIRSTNAME', gT("Firstname from token"));
                $replFields[] = array('TOKEN:LASTNAME', gT("Lastname from token"));
            ...
            case 'email-rem':
                ...
                $replFields[] = array('TOKEN', gT("Token code for this participant"));
                $replFields[] = array('OPTOUTURL', gT("URL for a respondent to opt-out this survey"));
                $replFields[] = array('OPTINURL', gT("URL for a respondent to opt-in this survey"));
            case 'email-reg':
                $replFields[] = array('FIRSTNAME', gT("Firstname from token"));
                $replFields[] = array('LASTNAME', gT("Lastname from token"));
                $replFields[] = array('SURVEYNAME', gT("Name of the survey"));
                $replFields[] = array('SURVEYDESCRIPTION', gT("Description of the survey"));
                $attributes = getTokenFieldsAndNames($surveyid, true);
                foreach ($attributes as $attributefield => $attributedescription)
