        ...
        <?php
            if (hasSurveyPermission($surveyid,'surveycontent','delete'))
            {
                if ((($sumcount4 == 0 && $activated != "Y") || $activated != "Y"))
                {
                    ...
                    <a href='#' onclick="if (confirm('<?php eT("Deleting this group will also delete any questions and answers it contains. Are you sure you want to continue?","js"); ?>')) { window.open('<?php echo $this->createUrl("admin/questiongroup/sa/delete/surveyid/$surveyid/gid/$gid"); ?>','_top'); }">
...
<?php
    ...
    {?>
    <tr>
        <td><?php eT("Randomization group:"); ?></td><td><?php echo $grow['randomgroup'];?></td>
    </tr>
    <?php
    }
