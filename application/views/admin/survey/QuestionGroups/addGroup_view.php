...
<div id='tabs'><ul>
    ...
    <?php if (hasSurveyPermission($surveyid,'surveycontent','import'))
        { ?>
        <div id="import">
            <?php echo CHtml::form(array("admin/questiongroup/sa/import"), 'post', array('id'=>'importgroup', 'name'=>'importgroup', 'class'=>'form30', 'enctype'=>'multipart/form-data', 'onsubmit'=>'return validatefilename(this,"'.gT('Please select a file to import!','js').'");')); ?>
                <ul>
                    <li>
