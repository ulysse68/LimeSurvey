<div class="header ui-tabs ui-widget ui-widget-content ui-corner-all"><?php eT("Edit quota");?></div>
...
<ul>
    ...
    <li><label for='quota_action'><?php eT("Quota action:");?></label> <select name="quota_action" id="quota_action">
            <option value ="1" <?php 
            if($quotainfo['action'] == 1) echo "selected='selected'"; ?>><?php eT("Terminate survey");?></option>
