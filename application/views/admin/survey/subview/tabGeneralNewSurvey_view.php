<div id='general'>
    <ul>
        ...
        <?php if(User::GetUserRights('manage_model')) { ?>
            <li><label for='type'><?php eT("Survey type:"); ?></label>
                <select name="type" id="type">
                    ...
                    <option value="M"><?php eT("Survey model"); ?></option>
                </select>
            </li>
        <?php } ?>
        ...
        <?php 
            //echo getEditor("survey-desc", "description", "[" . gT("Description:", "js") . "]", '', '', '', $action); 
        ?>
        </li>
        ...
        <?php 
            //echo getEditor("survey-welc", "welcome", "[" . gT("Welcome message:", "js") . "]", '', '', '', $action);
        ?>
        </div>
        </li>
