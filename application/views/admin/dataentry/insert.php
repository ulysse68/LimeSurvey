<div class='header ui-widget-header'><?php eT("Data entry"); ?></div>
	<div class='messagebox ui-corner-all'>
        ...
        <?php if(isset($thisid) && hasSurveyPermission($surveyid, 'responses','read')): ?>
			<input type='submit' value='<?php eT("View this record"); ?>' onclick="window.open('<?php echo $this->createUrl('/admin/responses/sa/action/surveyid/'.$surveyid.'/id/'.$thisid); ?>', '_top')" />
			<br /><br />
        <?php endif; ?>
