...
<?php echo CHtml::form(array("admin/database"), 'post', array('id'=>'editanswersform', 'name'=>'editanswersform')); ?>
    ...
    <div id='labelsetbrowser' class='labelsets-update' style='display:none;'><div style='float:left;width:260px;'>
        ...
        <input type="radio" name="savelabeloption" id="newlabel"> <label for="newlabel"><?php eT('New label set'); ?></label><br /><br />
        <input type="radio" name="savelabeloption" id="replacelabel"> <label for="replacelabel"><?php eT('Replace existing label set'); ?></label><br /><br />
