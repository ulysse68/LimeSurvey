...
<div class="container_6">
    ...
    <div class="grid_4 table">
        ...
        <div style="-moz-border-radius:15px; border-radius:15px;" >
            ...
            <hr />
            <br />
            <div class='messagebox'><div class='header'><?php eT('LimeSurvey setup'); ?></div>
...
<div class="container_6">
    ...
    <div class="grid_4 demo">
        ...
        <table style="font-size:11px; width: 694px;">
            <tbody>
                <tr>
                    <td align="left" style="width: 227px;"><input class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" type="button" value="<?php eT('Previous'); ?>" onclick="javascript: window.open('<?php echo $this->createUrl("installer/database"); ?>', '_top')" /></td>
