...
<script type="text/javascript">
    ...
    var exportToCSVTitle = "<?php eT("Export to CSV", 'js'); ?>";
...
<p><input type="button" name="addtosurvey" id="addtosurvey" value="<?php eT("Add to survey") ?>" />
</p>
...
<div id="notauthorised" title="notauthorised" style="display:none">
    <p>
<?php eT("This is a shared participant and you are not authorised to edit it"); ?></p>

</div>
<fieldset id="exportcsv" title="exportcsv" style="display:none">
        <legend><?php eT("Attributes to export:"); ?></legend>
        <p>
