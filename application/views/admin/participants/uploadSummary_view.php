...
<html>
    ...
    <body>
        <?php
        $uploadSummary = "<div class='header ui-widget-header'>" . gT("CPDB CSV summary") . "</div><div class='messagebox ui-corner-all'>";
            ...
            if (count($duplicatelist) > 0 || count($invalidemaillist) > 0 || count($invalidattribute) > 0)
            {
                ...
                if (!empty($duplicatelist) && (count($duplicatelist) > 0))
                {
                    ...
                    if($dupreason == "participant_id") {
                        $uploadSummary .= "<li>".sprintf(gT("They were found to be duplicate using the participant id field"))."</li>\n";
                    } else {
                        $uploadSummary .= "<li>".sprintf(gT("They were found to be duplicate using a combination of firstname, lastname and email fields"))."</li>\n";
                    }
